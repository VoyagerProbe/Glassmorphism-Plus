...
正式目录已收录本主题，2026-09-21 核对时仍为 v2.8.2。v2.8.3 已正式晋升 Stable／Latest，唯一安装包通过当前官方更新脚本的输入校验；市场同步仍须等待官方周期及 PR 合并。本轮未修改官方市场条目、简介、预览图或 v2.8.2 历史资产。下面旧的首次提交表单仅作历史记录，不要重复提交。
