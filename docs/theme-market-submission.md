...
## 当前跟进：只更新既有条目（2026-09-25）

正式目录已收录本主题，2026-09-25 核对时为 v2.8.3。v2.8.4 已正式晋升 Stable／Latest，唯一安装包通过当前官方更新脚本的只读验证，晋升前后 ZIP 完全一致；市场同步仍须等待官方周期及 PR 合并。本轮未修改官方市场条目、简介、预览图或任何历史资产。下面旧的首次提交表单仅作历史记录，不要重复提交。
