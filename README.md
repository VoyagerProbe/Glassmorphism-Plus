...
- 用户已完成当前安装包的实际使用测试，v2.8.2 已正式发布；原 iPhone Safari 各浏览／PWA 状态的完整实测范围仍未确认。自然更新、资料保护与主题往返边界见[启动兼容说明](docs/compatibility/service-worker.md)，原始后端验证见[历史记录](docs/compatibility/komari-1.5.md)。
